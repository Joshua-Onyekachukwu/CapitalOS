      ...
      <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[20px]">
          {idealUsersData.map((user) => (
            <div
              key={user.id}
              className="rounded-[15px] md:rounded-[20px] bg-white dark:bg-[#0f1629] border border-[#f1f5f9] dark:border-gray-800 overflow-hidden hover:shadow-lg transition-shadow group"
            >
              {/* Photo */}
              ...
              <div className="p-[22px] md:p-[25px]">
                <div className="flex items-center gap-[10px] mb-[10px]">
                  <div className="w-[36px] h-[36px] rounded-full bg-[#0f172a] text-primary-500 flex items-center justify-center text-[18px] flex-none">
