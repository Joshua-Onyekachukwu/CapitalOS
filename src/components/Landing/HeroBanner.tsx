  ...
  return (
    <>
      <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
        <div className="relative bg-[#06201b] rounded-[20px] md:rounded-[20px] overflow-hidden min-h-[480px] md:min-h-[560px] lg:min-h-[600px] xl:min-h-[640px]">
          {/* Left: Copy */}
          <div className="relative z-10 pt-[45px] pb-[280px] px-[20px] md:pt-[60px] md:px-[40px] lg:pt-[80px] lg:pb-[20px] lg:px-[50px] xl:pt-[90px] xl:px-[80px] lg:absolute lg:inset-y-0 lg:left-0 lg:w-[50%] lg:flex lg:flex-col lg:justify-center">
            ...
            <p className="text-[#ebebe0] text-[14px] md:text-[16px] lg:text-md xl:text-lg xl:max-w-[420px] leading-relaxed">
              Find the right investors. Send emails that get replies. Close your
              round. All without the spreadsheet chaos.
            </p>

            <div className="mt-[26px] md:mt-[24px] lg:mt-[30px] flex flex-col sm:flex-row gap-[16px] sm:gap-[12px]">
              <Link
                href="/signup"
                className="inline-block font-medium text-[14px] md:text-base rounded-[8px] bg-lime-500 text-black py-[10px] md:py-[11.5px] px-[20px] md:px-[25px] transition-all hover:bg-lime-600 text-center"
              >
                Start Free
              </Link>
              <Link
                href="/#how-it-works"
                className="inline-block font-medium rounded-[8px] border border-lime-500 text-[14px] md:text-base text-lime-500 py-[8.5px] md:py-[10.5px] px-[20px] md:px-[25px] transition-all hover:text-black hover:bg-lime-500 hover:border-lime-500 text-center"
              >
                See How It Works
              </Link>
            </div>

            <div className="mt-[28px] md:mt-[30px] lg:mt-[40px] flex flex-wrap gap-[12px] md:gap-[16px] text-[#ebebe0]/60 text-[12px] md:text-[13px] lg:text-[14px]">
