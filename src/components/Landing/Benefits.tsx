...
const benefits = [
  ...
  },
  {
    ...
    title: "Send Emails That Actually Get Replies",      description:
      "No more staring at a blank email wondering what to write. We use AI to draft messages that speak to each investor's thesis and recent activity. You review, edit if you want, and approve. That's it. Nothing goes out without your say-so.",
