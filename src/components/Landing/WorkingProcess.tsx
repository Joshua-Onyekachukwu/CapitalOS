...
const steps = [
  {
    ...
    description: "We use AI to find and score investors that match your stage, sector, and geography.",
  },
  {
    number: "2",
    title: "Review & Personalize",
    description: "We use AI to draft personalized emails. You review, edit, and approve before sending.",
  },
  {
    number: "3",
    title: "Track & Close",
      ...
      <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[24px]">
          ...
          <div className="ltr:xl:pl-[30px] rtl:xl:pr-[30px]">
            ...
            <p className="text-base md:text-[16px] lg:text-md -tracking-[0.16px] xl:max-w-[530px]">
              Capital OS is built to streamline the way you fundraise, from
              the first investor discovery to the final signed term sheet.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-[24px] mt-[25px] md:mt-[30px] lg:mt-[30px] xl:mt-[75px] ltr:xl:-ml-[267px] rtl:xl:-mr-[267px]">
              {steps.map((step, index) => (
                <div
                  key={index}
                  className="bg-[#E9DFDA] dark:bg-[#06201b] rounded-[8px] p-[20px] md:py-[25px]"
                >
                  <div className="mb-[16px] md:mb-[20px] xl:mb-[30px] leading-none italic text-black dark:text-white font-semibold text-xl">
                    {step.number}
                  </div>
                  <h3 className="!font-normal -tracking-[.2px] md:-tracking-[.3px] lg:-tracking-[.4px] !text-lg md:!text-[20px] lg:!text-[24px] xl:!text-xl !mb-[12px] xl:mb-[20px] xl:max-w-[120px]">
                    {step.title}
                  </h3>
