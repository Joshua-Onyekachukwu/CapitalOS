...
export default function NotFound() {
  return (
    <>
      <div className="pt-[140px] md:pt-[160px] lg:pt-[220px] xl:pt-[260px] 2xl:pt-[280px] py-[70px] md:py-[90px] lg:py-[110px] xl:py-[150px] 2xl:py-[180px] bg-gray-50 dark:bg-[#0f1629]">
